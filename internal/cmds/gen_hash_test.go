...
func hash0(s Builder) {
	...
	s.Hgetdel().Key("1").Numfields(1).Field("1").Field("1").Build()
	s.Hgetex().Key("1").Seconds(1).Numfields(1).Field("1").Field("1").Build()
	s.Hgetex().Key("1").Milliseconds(1).Numfields(1).Field("1").Field("1").Build()
	s.Hgetex().Key("1").UnixTimeSeconds(1).Numfields(1).Field("1").Field("1").Build()
	s.Hgetex().Key("1").UnixTimeMilliseconds(1).Numfields(1).Field("1").Field("1").Build()
	s.Hgetex().Key("1").Persist().Numfields(1).Field("1").Field("1").Build()
	s.Hgetex().Key("1").Numfields(1).Field("1").Field("1").Build()
	...
	s.Hsetex().Key("1").Fnx().Seconds(1).Numfields(1).Field("1").Value("1").Field("1").Value("1").Build()
	s.Hsetex().Key("1").Fnx().Milliseconds(1).Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Fnx().UnixTimeSeconds(1).Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Fnx().UnixTimeMilliseconds(1).Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Fnx().Keepttl().Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Fnx().Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Fxx().Seconds(1).Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Fxx().Milliseconds(1).Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Fxx().UnixTimeSeconds(1).Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Fxx().UnixTimeMilliseconds(1).Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Fxx().Keepttl().Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Fxx().Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Seconds(1).Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Milliseconds(1).Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").UnixTimeSeconds(1).Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").UnixTimeMilliseconds(1).Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Keepttl().Numfields(1).Field("1").Value("1").Build()
	s.Hsetex().Key("1").Numfields(1).Field("1").Value("1").Build()
