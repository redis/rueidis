...
func stream0(s Builder) {
	...
	s.Xadd().Key("1").Nomkstream().Delref().Acked().Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Delref().Acked().Maxlen().Exact().Threshold("1").Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Delref().Acked().Maxlen().Almost().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Delref().Acked().Maxlen().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Delref().Acked().Minid().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Delref().Acked().Minid().Almost().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Delref().Acked().Minid().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Delref().Acked().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	...
	s.Xadd().Key("1").Delref().Acked().Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Acked().Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
