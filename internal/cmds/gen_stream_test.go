...
func stream0(s Builder) {
	...
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Limit(1).Keepref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Limit(1).Delref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Limit(1).Acked().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	...
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Keepref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Delref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Acked().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Maxlen().Almost().Threshold("1").Limit(1).Keepref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Maxlen().Threshold("1").Limit(1).Keepref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Minid().Exact().Threshold("1").Limit(1).Keepref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Minid().Almost().Threshold("1").Limit(1).Keepref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Minid().Threshold("1").Limit(1).Keepref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmp().Pid("1").Iid("1").Maxlen().Exact().Threshold("1").Limit(1).Keepref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmp().Pid("1").Iid("1").Minid().Exact().Threshold("1").Limit(1).Keepref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmp().Pid("1").Iid("1").Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	...
	s.Xadd().Key("1").Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Limit(1).Keepref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Idmp().Pid("1").Iid("1").Maxlen().Exact().Threshold("1").Limit(1).Keepref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
