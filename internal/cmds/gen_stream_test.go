...
func stream0(s Builder) {
	...
	s.Xadd().Key("1").Nomkstream().Keepref().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Keepref().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Keepref().Idmpauto().Pid("1").Maxlen().Almost().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Keepref().Idmpauto().Pid("1").Maxlen().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Keepref().Idmpauto().Pid("1").Minid().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Keepref().Idmpauto().Pid("1").Minid().Almost().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Keepref().Idmpauto().Pid("1").Minid().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Keepref().Idmpauto().Pid("1").Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Keepref().Idmp().Pid("1").Iid("1").Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Keepref().Idmp().Pid("1").Iid("1").Minid().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Keepref().Idmp().Pid("1").Iid("1").Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Keepref().Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Keepref().Minid().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Keepref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Delref().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Delref().Idmp().Pid("1").Iid("1").Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Delref().Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Delref().Minid().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Delref().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Acked().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Acked().Idmp().Pid("1").Iid("1").Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Acked().Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Acked().Minid().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Acked().Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Nomkstream().Idmp().Pid("1").Iid("1").Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	...
	s.Xadd().Key("1").Keepref().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Delref().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Acked().Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Idmpauto().Pid("1").Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
	s.Xadd().Key("1").Idmp().Pid("1").Iid("1").Maxlen().Exact().Threshold("1").Limit(1).Id("1").FieldValue().FieldValue("1", "1").FieldValue("1", "1").Build()
