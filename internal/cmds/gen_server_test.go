...
func server0(s Builder) {
	...
	s.HotkeysStart().Metrics().Count(1).Cpu().Cpu().Cpu().Count(1).Duration(1).Sample(1).Slots().Count(1).Slot(1).Slot(1).Build()
	s.HotkeysStart().Metrics().Count(1).Cpu().Cpu().Cpu().Count(1).Duration(1).Sample(1).Build()
	s.HotkeysStart().Metrics().Count(1).Cpu().Cpu().Cpu().Count(1).Duration(1).Slots().Count(1).Slot(1).Slot(1).Build()
	s.HotkeysStart().Metrics().Count(1).Cpu().Cpu().Cpu().Count(1).Duration(1).Build()
	s.HotkeysStart().Metrics().Count(1).Cpu().Cpu().Cpu().Count(1).Sample(1).Build()
	s.HotkeysStart().Metrics().Count(1).Cpu().Cpu().Cpu().Count(1).Slots().Count(1).Slot(1).Slot(1).Build()
	s.HotkeysStart().Metrics().Count(1).Cpu().Cpu().Cpu().Count(1).Build()
	s.HotkeysStart().Metrics().Count(1).Cpu().Cpu().Cpu().Duration(1).Build()
	s.HotkeysStart().Metrics().Count(1).Cpu().Cpu().Cpu().Sample(1).Build()
	s.HotkeysStart().Metrics().Count(1).Cpu().Cpu().Cpu().Slots().Count(1).Slot(1).Slot(1).Build()
	s.HotkeysStart().Metrics().Count(1).Cpu().Cpu().Cpu().Build()
	s.HotkeysStart().Metrics().Count(1).Net().Net().Net().Count(1).Build()
	s.HotkeysStart().Metrics().Count(1).Net().Net().Net().Duration(1).Build()
	s.HotkeysStart().Metrics().Count(1).Net().Net().Net().Sample(1).Build()
	s.HotkeysStart().Metrics().Count(1).Net().Net().Net().Slots().Count(1).Slot(1).Slot(1).Build()
	s.HotkeysStart().Metrics().Count(1).Net().Net().Net().Build()
