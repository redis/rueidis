...
func sorted_set0(s Builder) {
	...
	s.Zinter().Numkeys(1).Key("1").Key("1").Weights(1).Weights(1).AggregateCount().Withscores().Build()
	s.Zinter().Numkeys(1).Key("1").Key("1").Weights(1).Weights(1).AggregateCount().Build()
	...
	s.Zinter().Numkeys(1).Key("1").Key("1").AggregateCount().Build()
	...
	s.Zinterstore().Destination("1").Numkeys(1).Key("1").Key("1").Weights(1).Weights(1).AggregateCount().Build()
	...
	s.Zinterstore().Destination("1").Numkeys(1).Key("1").Key("1").AggregateCount().Build()
...
func sorted_set1(s Builder) {
	...
	s.Zunion().Numkeys(1).Key("1").Key("1").Weights(1).Weights(1).AggregateCount().Withscores().Build()
	s.Zunion().Numkeys(1).Key("1").Key("1").Weights(1).Weights(1).AggregateCount().Build()
	...
	s.Zunion().Numkeys(1).Key("1").Key("1").AggregateCount().Build()
	...
	s.Zunionstore().Destination("1").Numkeys(1).Key("1").Key("1").Weights(1).Weights(1).AggregateCount().Build()
	...
	s.Zunionstore().Destination("1").Numkeys(1).Key("1").Key("1").AggregateCount().Build()
