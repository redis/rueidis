...
func cluster0(s Builder) {
	...
	s.Clusterscan().Cursor("1").Match("1").Count(1).Type("1").Slot(1).Build()
	s.Clusterscan().Cursor("1").Match("1").Count(1).Type("1").Build()
	s.Clusterscan().Cursor("1").Match("1").Count(1).Slot(1).Build()
	s.Clusterscan().Cursor("1").Match("1").Count(1).Build()
	s.Clusterscan().Cursor("1").Match("1").Type("1").Build()
	s.Clusterscan().Cursor("1").Match("1").Slot(1).Build()
	s.Clusterscan().Cursor("1").Match("1").Build()
	s.Clusterscan().Cursor("1").Count(1).Build()
	s.Clusterscan().Cursor("1").Type("1").Build()
	s.Clusterscan().Cursor("1").Slot(1).Build()
	s.Clusterscan().Cursor("1").Build()
	s.Readonly().Build()
	s.Readwrite().Build()
}
