...
func bf0(s Builder) {
	...
	s.BfInsert().Key("1").Capacity(1).Error(1).Nocreate().Items().Item("1").Item("1").Build()
	...
	s.BfInsert().Key("1").Capacity(1).Expansion(1).Nocreate().Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Capacity(1).Expansion(1).Nonscaling().Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Capacity(1).Expansion(1).Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Capacity(1).Nocreate().Nonscaling().Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Capacity(1).Nocreate().Items().Item("1").Item("1").Build()
	...
	s.BfInsert().Key("1").Error(1).Expansion(1).Nocreate().Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Error(1).Expansion(1).Nonscaling().Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Error(1).Expansion(1).Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Error(1).Nocreate().Nonscaling().Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Error(1).Nocreate().Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Error(1).Nonscaling().Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Error(1).Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Expansion(1).Nocreate().Nonscaling().Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Expansion(1).Nocreate().Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Expansion(1).Nonscaling().Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Expansion(1).Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Nocreate().Nonscaling().Items().Item("1").Item("1").Build()
	s.BfInsert().Key("1").Nocreate().Items().Item("1").Item("1").Build()
