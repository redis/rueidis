...
func json0(s Builder) {
	...
	s.JsonSet().Key("1").Path("1").Value("1").Nx().Fpha().Fp16().Build()
	s.JsonSet().Key("1").Path("1").Value("1").Nx().Fpha().Bf16().Build()
	s.JsonSet().Key("1").Path("1").Value("1").Nx().Fpha().Fp32().Build()
	s.JsonSet().Key("1").Path("1").Value("1").Nx().Fpha().Fp64().Build()
	s.JsonSet().Key("1").Path("1").Value("1").Nx().Build()
	s.JsonSet().Key("1").Path("1").Value("1").Xx().Fpha().Fp16().Build()
	s.JsonSet().Key("1").Path("1").Value("1").Xx().Build()
	s.JsonSet().Key("1").Path("1").Value("1").Fpha().Fp16().Build()
