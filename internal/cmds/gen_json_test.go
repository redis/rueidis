...
func json0(s Builder) {
	...
	s.JsonGet().Key("1").Indent("1").Space("1").Path("1").Path("1").Build()
	s.JsonGet().Key("1").Indent("1").Space("1").Path("1").Path("1").Cache()
	...
	s.JsonGet().Key("1").Newline("1").Space("1").Path("1").Path("1").Build()
	s.JsonGet().Key("1").Newline("1").Space("1").Path("1").Path("1").Cache()
	s.JsonGet().Key("1").Newline("1").Space("1").Build()
	s.JsonGet().Key("1").Newline("1").Space("1").Cache()
	s.JsonGet().Key("1").Newline("1").Path("1").Path("1").Build()
	s.JsonGet().Key("1").Newline("1").Path("1").Path("1").Cache()
	s.JsonGet().Key("1").Newline("1").Build()
	s.JsonGet().Key("1").Newline("1").Cache()
	s.JsonGet().Key("1").Space("1").Path("1").Path("1").Build()
	s.JsonGet().Key("1").Space("1").Path("1").Path("1").Cache()
	...
	s.JsonMset().Key("1").Path("1").Value("1").Build()
