...
func string0(s Builder) {
	...
	s.Getex().Key("1").ExSecTyped(time.Second).Build()
	s.Getex().Key("1").PxMsTyped(time.Second).Build()
	s.Getex().Key("1").ExatTimestampTyped(time.Now()).Build()
	s.Getex().Key("1").PxatMsTimestampTyped(time.Now()).Build()
	s.Getex().Key("1").Build()
	...
	s.Set().Key("1").Value("1").Nx().Get().ExSecTyped(time.Second).Build()
	s.Set().Key("1").Value("1").Nx().Get().PxMsTyped(time.Second).Build()
	s.Set().Key("1").Value("1").Nx().Get().ExatTimestampTyped(time.Now()).Build()
	s.Set().Key("1").Value("1").Nx().Get().PxatMsTimestampTyped(time.Now()).Build()
	...
	s.Set().Key("1").Value("1").Nx().ExSecTyped(time.Second).Build()
	s.Set().Key("1").Value("1").Nx().PxMsTyped(time.Second).Build()
	s.Set().Key("1").Value("1").Nx().ExatTimestampTyped(time.Now()).Build()
	s.Set().Key("1").Value("1").Nx().PxatMsTimestampTyped(time.Now()).Build()
	...
	s.Set().Key("1").Value("1").Xx().ExSecTyped(time.Second).Build()
	s.Set().Key("1").Value("1").Xx().PxMsTyped(time.Second).Build()
	s.Set().Key("1").Value("1").Xx().ExatTimestampTyped(time.Now()).Build()
	s.Set().Key("1").Value("1").Xx().PxatMsTimestampTyped(time.Now()).Build()
	...
	s.Set().Key("1").Value("1").ExSecTyped(time.Second).Build()
	s.Set().Key("1").Value("1").PxMsTyped(time.Second).Build()
	s.Set().Key("1").Value("1").ExatTimestampTyped(time.Now()).Build()
	s.Set().Key("1").Value("1").PxatMsTimestampTyped(time.Now()).Build()
