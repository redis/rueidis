...
type Cmdable interface {
	...
	Restore(ctx context.Context, key string, ttl int64, serializedValue string) *StatusCmd
	...
	SetEx(ctx context.Context, key string, value string) *StatusCmd
	SetNX(ctx context.Context, key string, value string, expiration time.Duration) *BoolCmd
...
func (c *Compat) Exists(ctx context.Context, keys ...string) *StringCmd {
