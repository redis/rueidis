...
func (r *JSONRepository[T]) AlterIndex(ctx context.Context, cmdFn func(schema FtAlterSchema) rueidis.Completed) error {
	return r.client.Do(ctx, cmdFn(r.client.B().FtAlter().Index(r.idx).Schema())).Error()
}
